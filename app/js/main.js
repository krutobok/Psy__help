const langArr = {
    ...
    "consult-text": {
        "ru": "Оставь заяву на безплатную психологическую поддержку уже сейчас. Наш специалист вам позвонит и предоставит психологическую помощь.",
    ...
    "why-title": {
        "ru": "В трудные времена воин защищает землю, пекарь печет хлеб, а психолог не дает сломаться морально.",
        "ua": "У скрутні часи воїн боронить землю, пекар пече хліб, а психолог не дає зламатися морально.",
    },
    "why-text": {
        "ru": " Начинаем бесплатную программу поддержки для всех, кому она нужна. Мы создали благотворительный украинский проект с привлечением неравнодушных психологов-волонтеров, которые действительно хотят помочь.",
        "ua": "Розпочинаємо безкоштовну програму підтримки для всіх, кому вона потрібна. Ми створили благодійний український проєкт із залученням небайдужих психологів-волонтерів, які справді хочуть допомогти.",
    },
    "about-title": {
        "ru": "Это нормально, если вы",
        "ua": "Це нормально, якщо ви",
    },
    "about-item-1": {
        "ru": "В панике, не знаете, что делать",
        "ua": "В паніці, не знаєте, що робити",
    },
    "about-item-2": {
        "ru": "Не можете избавиться от тривоги и стресса",
        "ua": "Не можете позбавитись тривоги та стресу",
    },
    "about-item-3": {
        "ru": "Чувствуете безнадёжность",
        "ua": "Відчуваєте безнадійність",
    },
    "about-item-4": {
        "ru": "Не можете спать и есть",
        "ua": "Не можете спати та їсти",
    },
    "about-item-5": {
        "ru": "Не чувствуете почву под ногами",
        "ua": "Не відчуваєте ґрунт під ногами",
    },
    "about-item-6": {
        "ru": "Имеете сложности с контролем чувств",
        "ua": "Маєте складнощі з контролем почуттів",
    },
    "about-item-7": {
        "ru": "Опустошенные и чувствуете печаль",
        "ua": "Спустошені та відчуваєте сум",
    },
    "about-item-8": {
        "ru": "Просто хотите поговорить о болезненном",
        "ua": "Просто хочете поговорити про болюче",
    },
    "language": {
        "ru": "Язык | ",
        "ua": "Мова | ",
